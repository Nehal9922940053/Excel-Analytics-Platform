...
//     // In DataTable.jsx, update the fetchData function:
...
//                 `http://localhost:5000/api/data/${analysisId}/data?page=${page}&limit=${itemsPerPage}`,
//                 config
//             );
...
//     //         const response = await axios.get(`/api/data/${analysisId}/data?page=${page}&limit=${itemsPerPage}`, config);
...
//                 <h2 className="text-lg font-medium text-gray-900">Data Preview</h2>
//                 <p className="mt-1 text-sm text-gray-500">
//                     Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, totalRows)} of {totalRows} records
//                 </p>
//             </div>
//             <div className="overflow-x-auto">
//                 <table className="min-w-full divide-y divide-gray-200">
...
//                                 <span className="font-medium">{Math.min(startIndex + itemsPerPage, totalRows)}</span> of{" "}
...
const DataTable = ({analysisId, columns}) => {
    ...
    const fetchData = async (page) => {
        ...
        try {
            ...
            let url = `http://localhost:5000/api/data/${analysisId}/data?page=${page}&limit=${itemsPerPage}`;
            if (searchTerm) {
